...
(def input
  (let [list-of-strs (-> "resources/input/day15"
                         slurp
                         (.split "\\n")
                         vec)]
    (->> list-of-strs
...
(defn get-at-coordinate
  [ipt [x y]]
  (try (aget ipt x y) (catch java.lang.ArrayIndexOutOfBoundsException e 10)))
